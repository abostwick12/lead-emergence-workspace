...
export default function OAuthConsentPage() {
  ...
  return <main className="auth-page"><section className="auth-card consent-card">
    ...
    <div className="consent-list" aria-label="Assigned bundle access">
      <p><Check size={16} />Executive can read assigned commitments, decisions, meeting plans and briefs, plus only the task metadata you explicitly share from other bundles. Source sharing starts off. Full private source bodies, inboxes, calendars and external actions are not included. It can save proposals; canonical saves, source-permission changes, proposal decisions and history remain native-only. No recurring automation is started by this connection.</p>
