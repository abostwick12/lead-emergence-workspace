...
export default function OAuthConsentPage() {
  ...
  return <main className="auth-page"><section className="auth-card consent-card">
    ...
    <div className="consent-list" aria-label="Assigned bundle access">
      <p><Check size={16} />Executive can read assigned commitments, decisions, meeting plans and briefs. Meeting plans can include availability you manually enter; this does not connect a calendar. Weekly-review access also permits a bounded outcome-history projection from currently assigned Executive areas, not full audit bodies or other bundles’ history. It can read only the task metadata you explicitly share from other bundles. Source sharing starts off. Full private source bodies, inboxes, calendars and external actions are not included. It can save proposals; canonical saves, source-permission changes, proposal decisions, native schedule controls and full revision history remain native-only. An assistant connection cannot create, change or trigger recurring schedules.</p>
