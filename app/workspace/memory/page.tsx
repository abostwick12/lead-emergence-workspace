...
export default function MemoryPage() {
  const { workspace, user, plan, capabilities } = useWorkspace(); const [items, setItems] = useState<MemoryRecord[]>([]);
