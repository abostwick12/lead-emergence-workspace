...
export async function connectedSotfExperience(initialSection?: SotfSection) {
  ...
  return <SotfExperience mode="connected" scheduling={networkingSchedulingHandoff(networkingBookingConfiguration())} initialSection={initialSection} />;
}
