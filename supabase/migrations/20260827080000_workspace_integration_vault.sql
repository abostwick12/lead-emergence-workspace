...
where plan_key = 'personal' and capability_key = 'external_connectors';
...
begin
  ...
  if not workspace_private.has_personal_capability(p_workspace_id, 'external_connectors') then
    raise exception 'External connectors are not included for this Workspace.' using errcode = '42501';
  end if;
