...
select is((select enabled from workspace.bundle_capabilities where bundle_key='sotf_transition' and capability_key='professional_context'),false,'the product migration leaves Professional Context off');
