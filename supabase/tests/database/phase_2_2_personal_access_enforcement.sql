...
select workspace_private.apply_personal_access_authority_projection(
  '00000000-0000-4000-8000-00000000d001','SPONSORED_ACCESS','SUSPENDED','family_comp_2026',27,
...
select workspace_private.apply_personal_access_authority_projection(
  '00000000-0000-4000-8000-00000000d001','SPONSORED_ACCESS','REVOKED','family_comp_2026',28,
...
select workspace_private.apply_personal_access_authority_projection(
  '00000000-0000-4000-8000-00000000d001','INTERNAL_OPERATOR','ACTIVE','operator_allowlist',29,
...
select set_config('request.jwt.claims','{"sub":"00000000-0000-4000-8000-00000000d201","role":"authenticated","aud":"https://workspace.leademergence.com/api/mcp","client_id":"00000000-0000-4000-8000-00000000d501","workspace_mcp":"true"}',true);
