...
function ProtectedShell({ children }: { children: React.ReactNode }) {
  ...
  return <div className="app-shell">
    ...
    <aside className="sidebar" data-open={navOpen}>
      ...
      <div className="sidebar-footer"><div className="signal-status"><p className="eyebrow">Connection status</p><p><span className="status-dot" />Reconnect required</p></div><Link className="settings-link" href="/workspace/settings"><Settings size={17} />Settings</Link><button className="sign-out" onClick={() => void signOut()}>Sign out</button></div>
    </aside>
